...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-gradient-to-b from-red-900 via-black to-black p-4 text-white'>
        <div className='flex flex-col p-4 justify-center max-w-screen-xl mx-auto h-full'>
            ...
            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/db69a301-dc5b-471c-afbc-af9ed6e3e70f" method='POST' className='flex flex-col w-full md:w-1/2' >
